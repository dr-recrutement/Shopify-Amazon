              ...
              <Card key={p.id} className={`p-8 relative flex flex-col justify-between ${p.popular ? 'border-2 border-brand-500 shadow-xl' : 'border border-gray-100'}`}>
                <div>
                  ...
                  <ul className="mt-6 space-y-3 text-sm">
                    ...
                    <li className="flex items-start gap-2"><CheckCircle2 size={16} className={p.marketplaceListing ? 'text-green-600 mt-0.5' : 'text-gray-300 mt-0.5'} /> Marketplace Sellia</li>
